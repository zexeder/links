...
- [WebVideoteka](http://webvideoteka.ru/) Огромное количество видеоматериалов и книг по различным веб-технологиям, которые собраны с просторов всего интернета.
...
- [Tutorialzine](http://tutorialzine.com/) Сайт с туториалами и ресурсами для веб-разработчика
- [Learn X in Y Minutes](http://learnxinyminutes.com/) Базовый синтаксис языков программирования.
